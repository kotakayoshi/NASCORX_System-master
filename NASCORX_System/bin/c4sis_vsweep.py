...
class Vsweep(object):
    ...
    def measure(self, repeat, initV=0.0, interval=0.1, onoff=[0]*12):
        ...
        # ---------------
        # TODO : HOT IN
        data_hot = self.sweep_sisv(repeat, initV=initV, interval=interval, onoff=onoff)

        # SKY measurement
        # ---------------
        # TODO : HOT OUT, OBS SKY
        data_sky = self.sweep_sisv(repeat, initV=initV, interval=interval, onoff=onoff)
    ...
    def sweep_sisv(self, repeat, initV=0.0, interval=0.1, onoff=[0]*12):
        data = []
        setV_list = [0] * 12
