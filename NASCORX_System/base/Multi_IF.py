...
class multi_prog_att(object):
    ...
    def communication_check(self):
        ret1 = self.driver1.query_IDN()
        ret2 = self.driver2.query_IDN()
        ret3 = self.driver3.query_IDN()
        ret4 = self.driver4.query_IDN()
        ret5 = self.driver5.query_IDN()
        ret6 = self.driver6.query_IDN()
